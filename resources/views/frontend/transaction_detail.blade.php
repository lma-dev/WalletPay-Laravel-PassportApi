    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
                ...
                <p class="mb-0">
                    @if ($transaction->type==1)
                    <span class="badge badege-pill badge-success">Income</span>
                    @elseif($transaction->type==2)
                    <span class="badge badege-pill badge-danger">Expense</span>
                    @endif
                </p>
            </div>
            <hr>
            ...
            <div class="d-flex justify-content-between">
                ...
                <p class="mb-0">{{ $transaction->description?$transaction->description:'-' }}</p>
            </div>
            <hr>
        </div>
    </div>
